    ...
    public partial class O2O_DiretorDetalhe : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Biografia de Christopher Nolan", new DateTime(1970, 7, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 2, "Biografia de Steven Spielberg", new DateTime(1946, 12, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), 2 }
                });
